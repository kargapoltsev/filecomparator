...
void DirectoryHandler::handleDirectory(const std::filesystem::path &directoryPath)
{
...
bool DirectoryHandler::has(std::size_t size)
{
	return find(size) != end();
}

void DirectoryHandler::fill()
{
